...
import com.example.chitchat.databinding.ItemContainerRecentConversionBinding;
...
public class RecentConversionAdapter extends  RecyclerView.Adapter<RecentConversionAdapter.ConversionViewHolder> {
    ...
    class ConversionViewHolder extends RecyclerView.ViewHolder{
        ...
        void setData(ChatMessage chatMessage){
            binding.roundedImageView2.setImageBitmap(getConversionImage(chatMessage.conversionImage));
